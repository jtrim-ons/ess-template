...
import Cell from "$lib/prototypeComponents/topics/keyIndicators/options/colouredBoxes/Cell.svelte";
import { getContext } from 'svelte';

export let chosenId1, chosenId2, chosenId3, indicatorsMetadata, initialData, latestData, j, row, indicatorsCalculations;
