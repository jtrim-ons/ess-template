...
export let selectedAreas, areasWithData, globalVisibleAreasTracker, includeSiblings = true, parentArea;
...
<div class={"twisty-container"}>
    ...
    <Twisty label={"Add areas to compare to "+selectedArea.areanm} {open}>
        ...
        <div class="comparisonInputContainer">
            ...
            {#each selectedAreas as input, i}
                ...
                <label>
                    <input type="checkbox" bind:checked={globalVisibleAreasTracker[input.role]} />{input.areanm}
                </label>
            ...
            <p>Related areas</p>
                ...
                {#each ["neighbour", "cluster"] as input,i}
                    ...
                    <label>
                        <input type="checkbox" bind:checked={globalVisibleAreasTracker[input]} />{input === "neighbour" ? "Other areas in "+parentArea : "Statistically similar areas"}
                    </label>
