<script>
	...
	: (label, filterText, option) => `${option[labelKey]}`.match(new RegExp(`\\b${filterText}`, 'i'));
...
<div class="selectbox" class:multi-selected={value && isMulti} class:focused={isFocused} class:selected={value && !listOpen && !isMulti}
		 bind:this={el}
		 style:--borderColor={borderColor} style:--firstItem={getColor(0)} style:--secondItem={getColor(1)} style:--thirdItem={getColor(2)} style:--fourthItem={getColor(3)} style:--fifthItem={getColor(4)} style:--sixthItem={getColor(5)} style:--seventhItem={getColor(6)} style:--eighthItem={getColor(7)} style:--ninethItem={getColor(8)} style:--tenthItem={getColor(9)}>
	<Select
...
<style>
	...
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(5)) {
		background-color: var(--fifthItem) !important;
	}
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(6)) {
		background-color: var(--sixthItem) !important;
	}
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(7)) {
		background-color: var(--seventhItem) !important;
	}
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(8)) {
		background-color: var(--eighthItem) !important;
	}
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(9)) {
		background-color: var(--ninethItem) !important;
	}
	:global(.selectbox .selectContainer > .multiSelectItem:nth-of-type(10)) {
		background-color: var(--tenthItem) !important;
	}
