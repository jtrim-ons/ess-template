<script>
	...
	import { getData, getColor, getTopo } from "@onsvisual/svelte-maps/src/js/utils.js";
	import MapSource from '@onsvisual/svelte-maps';
	import MapLayer from '@onsvisual/svelte-maps';
